<?php
require_once 'inc_priceslider/incfuntion.php';
?>
...
//========================================================================
       ...
       if( ($( "#slider-range" ).slider( "values", 0 ) == $( "#slider-range" ).slider( "values", 0 )) && $( "#slider-range" ).slider( "values", 0 ) != 0 )
       {
    ...
    }  else if( $( "#slider-range" ).slider( "values", 0 ) == $( "#slider-range" ).slider( "values", 0 ) ) 
			{
...
<div id='plabel' class="lnup"><h6><?php _e('Price:', 'cars_attributes'); ?></h6></div> 
