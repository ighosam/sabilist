...
<?php
osc_enqueue_style('style8', osc_current_web_theme_url('css/change/sam.css'));
osc_enqueue_style('style9', osc_current_web_theme_url('css/change/green.css'));
...
osc_register_script('jtouch', osc_current_web_theme_js_url('jquery.ui.touch-punch.min.js'));
