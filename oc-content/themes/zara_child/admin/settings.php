...
<div class="mb-body">
  ...
  <div class="mb-box">
    ...
    <form action="<?php echo osc_admin_render_theme_url('oc-content/themes/' . osc_current_web_theme() . '/admin/settings.php'); ?>" method="post">
      ...
      <div class="mb-inside">
        <div class="mb-row"><?php _e('Banner section & configuration can be found in Zara Configurator plugin', 'zara'); ?></div>
      </div>
  ...
  <div class="mb-box" id="mb-help">
    ...
    <div class="mb-inside">
      ...
      <div class="mb-row mb-help"><span class="sup">(6)</span> <div class="h6"><?php _e('I want to help OSClass & MB themes by linking to <a href="http://osclass.org/" target="_blank">osclass.org</a> and <a href="http://www.mb-themes.com" target="_blank">MB-Themes.com</a> from my site', 'zara'); ?></div></div>
