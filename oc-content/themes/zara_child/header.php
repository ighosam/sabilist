      ...
      <div class="my-wrap">
        ...
        <div class="bottom-inside">
          ...
          <?php if(function_exists('fi_list_items')) { ?>
            <a href="<?php echo osc_route_url('favorite-lists', array('list-id' => '0', 'current-update' => '0', 'notification-update' => '0', 'list-remove' => '0', 'iPage' => '0')); ?>" class="elem"><?php _e('My favorite items', 'favorite_items'); ?></a>
          <?php } ?>
