                ...
                <?php if(osc_count_item_resources() > 1 && osc_get_preference('item_pager', 'zara_theme') == 1) { ?>
                  <div id="item-bx-pager">
                    ...
                    <?php for( $i = 0; osc_has_item_resources(); $i++ ) { ?>
                      ...
                      <a data-slide-index="<?php echo $i; ?>" href="" class="bx-navi<?php if($i == osc_count_item_resources()) { ?> last<?php } ?>">
                        <img src="<?php echo osc_resource_thumbnail_url(); ?>" alt="<?php echo osc_esc_html(osc_item_title()); ?> - <?php _e('Image', 'zara'); ?> <?php echo $i;?>/<?php echo osc_count_item_resources();?>"/>
          ...
          <div class="sc-block body">
            ...
            <div id="item-buttons">
              ...
              <div id="report" class="noselect tr1">
                <a href="#" title="<?php echo osc_esc_html(__('Report item', 'zara')); ?>"><i class="fa fa-flag-o"></i></a>
