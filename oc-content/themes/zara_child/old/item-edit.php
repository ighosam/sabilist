...
<head>
 ...
 = $("div[id*='uniform-']", div_plugin_hook ).size();
        if( num_uniform == 0 ){
...
<body id="body-item-edit">
  ...
  <script>
    $(document).ready(function(){
          ...
          $.ajax({
            ...
            success: function(data) {
              ...
              if(length > 0) {
                ...
                $("#city").before('<select name="sCity" id="cityId"><option selected="selected" value=""><?php echo osc_esc_js(__('Select a city', 'zara')); ?></option></select>').remove();
                ...
                $("#cityId").before('<input placeholder="<?php echo osc_esc_js(__('Enter a city', 'zara')); ?>" type="text" name="sCity" id="city" />').remove();;
          ...
          $.ajax({
            ...
            success: function(data){
              ...
              if(length > 0) {
                ...
                $("#city").before('<select name="sCity" id="cityId"><option value="" selected="selected"><?php echo osc_esc_js(__('Select a city', 'zara')); ?></option></select>').remove();
                $("#cityId").val("").html(result).attr('disabled',false);

              } else {
                $("#cityId").before('<input type="text" placeholder="<?php echo osc_esc_js(__('Enter a city', 'zara')); ?>" name="sCity" id="city" />').remove().val('').attr('disabled',false);
              }
      ...
      $("input#region").live("change", function(){
        if( $(this).val() != '' ) {
