...
<head>
  <?php //osc_current_web_theme_path('head.php') ; ?>
   <?php include 'oc-content/themes/zara_child/head.php' ?>
</head>

<body id="body-home">
  <?php //osc_current_web_theme_path('header.php') ; ?>
  <?php include 'oc-content/themes/zara_child/header.php' ?>;
