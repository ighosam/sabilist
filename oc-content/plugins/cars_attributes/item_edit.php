<?php //ADDED VALIDATION RULES USING JQUERY BY SAM ?>
...
$("#kilometers").rules("add", {
			
				required: true, 
				digits: true,
				messages : {
							required: "input is required!",
							digits: "Please enter only digits for kilometers field"
...
$("#year").rules("add", {required: true, messages : {required: "input is required!" }});
});
</script>

<?php //END OF THE RULES ADDITION TO HELP VALIDATE CAR PLUGINS FORM FIELD, FOR OTHERS FIELD CHECK item_edit.php validation ruled for the theme ?>
...
<div>
    ...
    <div class="row _200">
        ...
        ?>
       <label><?php _e('Year', 'cars_attributes'); ?><span class="req">*</span></label>
      <!--
        <input type="text" name="year" id="year" value="<?php echo @$detail['i_year']; ?>" size=4 />
        -->  

               <?php include 'select_year.php'; ?>
    ...
    <div class="row _200">
        <?php
            if( Session::newInstance()->_getForm('pc_kilometers') != '' ) {
                $detail['i_kilometers'] = Session::newInstance()->_getForm('pc_kilometers');
            }
        ?>
        <label><?php _e('Kilometers', 'cars_attributes'); ?></span><span class="req">*</span></label>
      <input type="text" name="kilometers" id="kilometers" value="<?php echo @$detail['i_kilometers']; ?>" />  
    </div>
    <div class="row _200">
        <?php
    ...
    <div class="row _200">
        ...
        <select name="fuel" id="fuel">
            ...
            <option value="PETROL" <?php if(@$detail['e_fuel'] == 'PETROL') { echo 'selected'; } ?>><?php _e('Petrol', 'cars_attributes'); ?></option>
