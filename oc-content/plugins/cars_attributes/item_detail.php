...
<table style="margin-left: 20px;">
    ...
    <?php } ?>
    <?php if( !empty($detail['i_kilometers']) ) { ?>
    <tr>
        <td width="150px"><label><?php _e('Kilometers', 'cars_attributes'); ?></label></td>
        <td width="150px"><?php echo @$detail['i_kilometers']; ?></td>
    </tr>
    <?php } ?>
    ...
    <tr>
        <?php $fuel = array('DIESEL'          => __('Diesel', 'cars_attributes')
                           ,'PETROL'        => __('Petrol', 'cars_attributes')
