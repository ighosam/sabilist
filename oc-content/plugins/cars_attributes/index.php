...
//======================================================
 ...
 require_once 'get_maxmileage.php';
...
//=======================================================
    ...
    function cars_search_conditions($params) {
        ...
        //==========================================================                         
        //ADDED BY SAM DARO, PART OF THE MILEAGE AND YEAR ADDITION     
                  ...
                  /*
					...
					$min_year = date("Y",strtotime("-5 year"));
					}

					if($min_kilometer >= $max_kilometer)
					{
        ...
        foreach($params as $key => $value) {
            ...
            switch($key) {
                ...
                break;
               //===================================================    
               // start of sam addition for min and max for year
               ...
               //end of sam addtion for min and max year

              // start of sam addition for min and max for kilometer
               ...
               //end of sam addtion for min and max for kilometer
               //==============================================================
    ...
    function cars_pre_item_post() {
        ...
        Session::newInstance()->_setForm('pc_kilometers', Params::getParam("kilometers"));
        ...
        Session::newInstance()->_keepForm('pc_kilometers');
    ...
    function _getCarParameters() {
        ...
        $kilometers  = (Params::getParam("kilometers") == '') ? null : Params::getParam("kilometers");
